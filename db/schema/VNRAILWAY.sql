...
ALTER TABLE NHAN_VIEN ADD
	...
	CONSTRAINT FK3_NV_NVQL FOREIGN KEY (MaNVQL) REFERENCES NHAN_VIEN(MaNV);
...
ALTER TABLE TUYEN_GA
ADD CONSTRAINT UQ_TUYEN_GA_MaTuyen_TrinhTu
UNIQUE (MaTuyen, TrinhTu);
