/* Cập nhật tuyến */
CREATE OR ALTER PROC usp_11_err_CapNhatTuyen
	@MaTuyen NCHAR(4),
...
BEGIN TRAN;
	...
	-- 11. Cập nhật danh sách ga của tuyến
	...
	-- 12. Cập nhật danh sách ga của chuyến thuộc tuyến
...
--EXEC @ReturnCode = usp_11_err_CapNhatTuyen N'TN16', N'Hải Phòng – Hà Nội', @DanhSachGa , @ThongBao OUT;
