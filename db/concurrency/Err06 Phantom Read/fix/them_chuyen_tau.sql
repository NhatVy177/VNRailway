...
RETURN 0;
GO
-- Giao tác 2: Thêm chuyến mới (Chạy thật nhanh để chen vào)
DECLARE @Out NVARCHAR(200);
-- Đổi ngày giờ khác đi một chút để tránh trùng khóa chính nếu chạy nhiều lần
EXEC usp_ThemChuyenTau 'TN01', 'D009', '2026-03-25 08:00:00', @Out OUT;
SELECT @Out;
--select * from TUYEN_DOANTAU where MaTuyen = 'TN01'
