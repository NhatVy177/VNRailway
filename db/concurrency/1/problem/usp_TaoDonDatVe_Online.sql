...
CREATE OR ALTER PROC usp_1_err_TaoDonDatVe_Online
...
-- =============================================
PRINT N'========================================';
PRINT N'TEST: usp_TaoDonDatVe_Online_V2_Full_ERR';
PRINT N'========================================';
PRINT N'⚠️ VERSION CÓ LỖI - Không lock ghế';
PRINT N'';

DECLARE @MaDon nchar(10), @ThongBao nvarchar(200);
DECLARE @RetCode int;

EXEC @RetCode = usp_1_err_TaoDonDatVe_Online
    @MaChuyenTau = 'VNW1E8BEE6',
    @MaGaDi = 'GA009',
    @MaGaDen = 'GA008',
    @MaKH_NguoiDat = 'U000011',
    @PhuongThucTT = N'Tiền mặt',
    @DanhSachVe = N'[
  {
    "maToa": "T0066", "maCho": "GIB007", "maThamSo": "TS009",
    "hoTen": "Nguyễn Văn An", "cmnd": "121111111111",
    "sdt": "0912345688", "ngSinh": "1990-05-15", "diaChi": "123 Lê Lợi"
  },
  {
    "maToa": "T0066", "maCho": "GIB008", "maThamSo": "TS011",
    "hoTen": "Trần Thị Bích", "cmnd": "212222222222",
    "sdt": "0987654322"
  },
  {
    "maToa": "T0066", "maCho": "GIB009", "maThamSo": "TS010",
    "hoTen": "Lê Văn Cường", "cmnd": "313333333333"
  }
]',
