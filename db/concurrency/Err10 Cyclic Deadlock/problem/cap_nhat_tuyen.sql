...
BEGIN TRAN;
	...
	-- 13. Cập nhật danh sách ga của tuyến
	...
	-- 14. Cập nhật danh sách ga của chuyến thuộc tuyến
...
--EXEC @ReturnCode = usp_11_err_CapNhatTuyen N'TN07', N'Hà Nội – Lạng Sơn - Đồng Đăng', @DanhSachGa , N'U010007', @ThongBao OUT;
