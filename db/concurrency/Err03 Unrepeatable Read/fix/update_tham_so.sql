...
-- =============================================
-- PROCEDURE: sp_UpdateThamSo (OPTIMIZED VERSION)
-- Gộp validation + update vào 1 SP duy nhất
-- Loại bỏ sp_ValidateThamSo (code duplicate)
-- =============================================
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- =============================================
        -- PHASE 2: SPECIFIC VALIDATION + LOCKING
        -- =============================================
        ...
        FROM THAM_SO WITH (UPDLOCK, HOLDLOCK)  -- ⭐ LOCK!
        WHERE MaThamSo IN (
        ...
        -- Validate tỷ lệ giảm giá (0.0 - 1.0)
        ...
        -- =============================================
        -- PHASE 3: CROSS-VALIDATION (với data đã lock)
        -- =============================================
...
-- Update TS001 xuống còn 1 (trong khi ông khách kia đang mua 3 vé)
