...
CREATE OR ALTER PROC usp_TaoDonDatVe_Online_ERR
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- DELAY để tăng khả năng Lost Update
...
PRINT N'========================================';
PRINT N' VERSION CÓ LỖI - Không lock ghế';
PRINT N'';

DECLARE @MaDon nchar(10), @ThongBao nvarchar(200);
DECLARE @RetCode int;

EXEC @RetCode = usp_TaoDonDatVe_Online_ERR
    @MaChuyenTau = 'VNW1E8BEE6',
    @MaGaDi = 'GA009',
    @MaGaDen = 'GA008',
    @MaKH_NguoiDat = 'U000001',
    @PhuongThucTT = N'Chuyển khoản',
    @DanhSachVe = N'[
  {
    "maToa": "T0067", "maCho": "GIA007", "maThamSo": "TS009",
    "hoTen": "Nguyễn Văn An", "cmnd": "001341972210"
  },
  {
    "maToa": "T0067", "maCho": "GIA008", "maThamSo": "TS010",
    "hoTen": "Lê Văn Cường", "cmnd": "086872678432"
  },
  {
    "maToa": "T0067", "maCho": "GIA009", "maThamSo": "TS010",
